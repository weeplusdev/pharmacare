-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CUSTOMER', 'DOCTOR', 'ADMIN');
...
-- CreateEnum
CREATE TYPE "PrescriptionStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'FILLED');
...
CREATE TABLE "Product" (
    ...
    "requireRx" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "User_medicalLicenseId_key" ON "User"("medicalLicenseId");
...
-- AddForeignKey
ALTER TABLE "PrescriptionMedication" ADD CONSTRAINT "PrescriptionMedication_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
